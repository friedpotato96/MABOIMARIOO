...
function startGame() {
  gameStatus = "start";
  document.getElementById("status").innerHTML = "Game Is LOAAAAAAAAAADEDIng";
}
...
function game() {
  ...
  if (gameConfig.status === 'start') {
    ...
    textSize(40);
    textAlign(CENTER);
    text("use your nonexisten brain to solve how to start", gameConfig.screenX / 2, gameConfig.screenY / 2);
    textSize(40);
